...
\begin{document}
	...
	\\
	We begin by asking an intuitively obvious, but mathematically difficult question: \textit{what even is curvature?} We know from our daily experience what curvature is. The way a snake moves, the path a ball takes flying through the air, or the ripples of a pond a thrown pebble makes are all examples of this idea of curvature. Compare this to the jagged teeth of a saw blade, a zig-zag path, or even mathematical objects like triangles and squares. These seem decidedly less curvy than the previous examples. 
	\newpage
